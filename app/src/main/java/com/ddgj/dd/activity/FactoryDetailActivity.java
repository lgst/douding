        ...
        favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (UserHelper.getInstance().isLogined())
                    ...
                    startActivity(new Intent(FactoryDetailActivity.this, LoginActivity.class));
            }
        });
            ...
            if (status == STATUS_SUCCESS) {
                ...
                if (mFactory != null) {
                    ...
                    if (mFactory.getHead_picture() != null) {
                        Glide.with(getApplicationContext()).load(NetWorkInterface.HOST + "/" + mFactory.getHead_picture()).into(mHeadPic);
                    }
                    if (mFactory.getFacilitator_license() != null) {
                        Glide.with(getApplicationContext()).load(NetWorkInterface.HOST + "/" + mFactory.getFacilitator_license()).into(mLicensepic);
                    } else {
                    ...
                    if (mFactory.getFacilitator_picture() != null) {
                        ...
                        for (int i = 0; i < imgs.length; i++) {
                            ...
                            if (!imgs[i].equals("null")) {
                                ...
                                Glide.with(getApplicationContext()).load(NetWorkInterface.HOST + "/" + imgs[i]).into(imageView);
                                mImagesList.add(NetWorkInterface.HOST + "/" + imgs[i]);
                                imageView.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        startActivity(new Intent(FactoryDetailActivity.this, PreviewImageActivity.class)
                                                .putExtra(PreviewImageActivity.PARAMAS_POSITION, mFacilitatorPic.indexOfChild(v))
